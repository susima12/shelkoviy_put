        ...
        <div className="container max-w-4xl space-y-10">
          ...
          <Card className="p-8">
            ...
            <ul className="space-y-2 text-sm text-muted-foreground leading-relaxed">
              ...
              <li>Оргвзнос за участие перечисляется до {FESTIVAL_2026.applicationDeadline} г.</li>
              <li>Копии платежных документов направляются на email: {FESTIVAL_2026.email} с пометкой «Оплата Оргвзноса, название конкурса, ФИО участника/коллектива».</li>
              <li>В назначении платежа указывается конкретный конкурс и название коллектива или ФИО участника (не плательщика).</li>
              <li>Именные дипломы и благодарственные письма — 100 ₽ за единицу (формат А4), заказ через оргкомитет.</li>
